...
class TestFluxSampling:
    ...
    def test_predict_generates_valid_image(self, flux_trainer, sample_image, reference_embeddings):
        ...
        assert_ralative_error_tensor(embeddings["control_latents"], reference_embeddings["control_latents"])
        assert_ralative_error_tensor(embeddings["control_ids"], reference_embeddings["control_ids"])
        assert_ralative_error_tensor(embeddings["control"], reference_embeddings["control"])
